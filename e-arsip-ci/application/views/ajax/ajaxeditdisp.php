                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="pengisi" id="pengisi" class="form-control" required>
                                ...
                                <option value="Plt.KADISHUB">Plt.KADISHUB</option>
                                <option value="Kabid Lalin Dan Angkutan">Kabid Lalin Dan Angkutan</option>
                                <option value="Kabid Prasarana & Keselamatan">Kabid Prasarana & Keselamatan</option>
                                <option value="Kasubbag Program Dan Keuangan">Kasubbag Program Dan Keuangan</option>
                                <option value="KASUBBAG UMUM">KASUBBAG UMUM</option>
                                <option value="MasterAdmin">MasterAdmin</option>
                                <!-- petinggi=superadmin->pegawai=admin -->
                                <!-- pengecekan berkala dilakukan oleh setiap user terutama master admin -->
                            </select>
