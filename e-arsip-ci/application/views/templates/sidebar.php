...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('') ?>">
        ...
        <img src="<?= base_url('vendor/') ?>img/logo.png" width="65">
        </div>
        <div class="sidebar-brand-text mx-3">E-Arsip <br>DISHUB KUANSING</div>
    </a>
    ...
    <div class="sidebar-heading">
        Data Master Aplikasi Administrasi Surat DISHUB
    </div>

    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item 
    <?php if (current_url() == base_url('admin/suratmasuk') or current_url() == base_url('admin/suratkeluar') or current_url() == base_url('admin/pembuatansurat')) {
        echo 'active';
    } ?>">
    ...
    <?php if (current_url() == base_url('admin/about')) {
        ...
        <a class="nav-link" href="<?= base_url('admin/about') ?>">
            ...
            <span>Seputar Pegawai DISHUB</span>
        </a>
    </li>
